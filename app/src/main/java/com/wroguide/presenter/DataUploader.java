...
public class DataUploader {
    ...
    private void uploadBridgesPl(){
        ...
        //MOST GRUNWALDZKI PL
        image = "https://firebasestorage.googleapis.com/v0/b/wroguide-b3379.appspot.com/o/grun1.jpg?alt=media&token=09b10b9b-2648-481f-8cda-7d8e4f099cf2";
        ...
        latitude = 51.109497;
        longitude = 17.052549;
        Bridge bridge1 = new Bridge(image, content, title, description, latitude, longitude);

        //MOST POKOJU PL
        image = "https://firebasestorage.googleapis.com/v0/b/wroguide-b3379.appspot.com/o/pokoju.jpg?alt=media&token=f98a7ec3-b5cf-4050-b50a-fe9218d488a8";
        title = "Most Pokoju";
        ...
        latitude = 51.111739;
        longitude = 17.049236;
        Bridge bridge2 = new Bridge(image, content, title, description, latitude, longitude);

        //MOST MILENIJNY PL
        image = "https://firebasestorage.googleapis.com/v0/b/wroguide-b3379.appspot.com/o/mile1.jpg?alt=media&token=fafd3892-f7e1-4d97-b915-b4990cfcae5a";
        ...
        latitude = 51.134091;
        longitude = 16.993900;
        Bridge bridge3 = new Bridge(image, content, title, description, latitude, longitude);

        //MOST RĘDZIŃSKI PL
        image = "https://firebasestorage.googleapis.com/v0/b/wroguide-b3379.appspot.com/o/redz2.jpg?alt=media&token=4fea8e60-e150-4949-b461-b130c757aa03";
        ...
        latitude = 51.157573;
        longitude = 16.960763;
        Bridge bridge4 = new Bridge(image, content, title, description, latitude, longitude);

        //MOST ZWIERZYNIECKI PL
        image = "https://firebasestorage.googleapis.com/v0/b/wroguide-b3379.appspot.com/o/zwierzyniecki.jpg?alt=media&token=e157eb30-cedb-4d21-8159-02a58b14025c";
        ...
        latitude = 51.108056;
        longitude = 17.07;
        Bridge bridge5 = new Bridge(image, content, title, description, latitude, longitude);

        //MOST TUMSKI PL
        image = "https://firebasestorage.googleapis.com/v0/b/wroguide-b3379.appspot.com/o/tums2.jpg?alt=media&token=6a515106-0a89-4589-9fa5-0f7a3fac1121";
        title = "Most Tumski";
        ...
        latitude = 51.114716;
        longitude = 17.042225;
        Bridge bridge6 = new Bridge(image, content, title, description, latitude, longitude);

        //MOST ŚW. KLARY PL
        image = "https://firebasestorage.googleapis.com/v0/b/wroguide-b3379.appspot.com/o/klary.jpg?alt=media&token=a42f0720-baf6-419d-b55c-d5798c9f72f1";
        title = "Most Św. Klary";
        ...
        latitude = 51.116667;
        longitude = 17.039167;
        Bridge bridge7 = new Bridge(image, content, title, description, latitude, longitude);
